...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const plants = [
        ...
        },
        {
            ...
            name: "Pothos",
            type: "Indoor",
            image: "https://images.unsplash.com/photo-1586093248292-4e6f6c2b8e3e?w=400",
        ...
        },
        {
            ...
            name: "Lavender",
            type: "Herb",
            image: "https://images.unsplash.com/photo-1611909023032-2d4b3a2e7d3d?w=400",
        ...
        card.innerHTML = `
            ...
            <div class="plant-info">
                ...
                <div class="plant-tags">
                    <span class="plant-tag difficulty-${plant.difficulty}">${plant.difficulty}</span>
